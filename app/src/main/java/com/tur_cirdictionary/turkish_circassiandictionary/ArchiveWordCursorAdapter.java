...
public class ArchiveWordCursorAdapter extends CursorAdapter {

    public ArchiveWordCursorAdapter(Context context, Cursor c) {
        super(context, c);
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        TextView tv_suggestedWord = view.findViewById(R.id.tv_word_archive);
